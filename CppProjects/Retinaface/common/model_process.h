...
public:
    ...
    */
    ...
    /**
     * @brief Create Input data space
     * 
     * @param inputBuffers      input buffers
     * @param inputBufferSize   input buffers size
     * @return Result 
     */
    Result CreateInput(std::vector<void *> inputBuffers, std::vector<size_t> inputBufferSize);
    ...
    */
    ...
    /**
    * @brief get model input image width
    * @return output image width
    */
    const uint32_t GetModelWidth();

    /**
    * @brief get model input image height
    * @return output image height
    */
    const uint32_t GetModelHeight();
